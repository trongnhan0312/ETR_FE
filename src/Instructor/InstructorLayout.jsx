          ...
          <div className="user-profile">
            ...
            <div className="user-info">
              <div className="user-name" title={user.fullName}>
                {user.fullName.length > 15 ? user.fullName.substring(0, 13) + '...' : user.fullName}
              </div>
      ...
      <div className="academic-main">
        ...
        <header className="academic-topbar">
          <div className="search-wrapper">
            ...
            <div style={{ fontSize: '11px', fontWeight: '700', color: 'rgba(0, 33, 71, 0.4)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          ...
          <div className="topbar-right">
            {/* Notifications */}
            <button className="notification-btn" type="button" aria-label="Notifications" onClick={() => alert('Không có thông báo mới.')}>
            ...
            {/* Language Selection */}
            <button className="lang-switcher" type="button" onClick={() => alert('Chuyển đổi ngôn ngữ đang được phát triển.')}>
