...
const navigationItems = [
  { label: 'DASHBOARD', to: '/admin', icon: iconDocument },
  { label: 'USER MANAGEMENT', to: '/admin/users', icon: iconUsers },
  { label: 'ROLE & PERMISSION', to: '/admin/roles', icon: iconDocument },
  { label: 'AUDIT LOG', to: '/admin/audit', icon: iconDocument },
  { label: 'SYSTEM CONFIG', to: '/admin/config', icon: iconDocument },
];
      ...
      <div className="admin-main">
        ...
        <header className="admin-topbar">
          <div className="search-wrapper">
            ...
            <input type="text" className="search-input" placeholder="Tìm kiếm người dùng, vai trò..." />
          </div>
