  ...
  return (
    <div className="public-page-container">
      <div className="detail-page-wrapper">
        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: '48px', color: '#94a3b8' }}>Loading article...</div>
        ) : !article ? (
          <div style={{ textAlign: 'center', padding: '48px', color: '#94a3b8' }}>Article not found.</div>
        ) : (
          <article className="news-detail-article">
            <div className="article-meta">
              <span className="badge-tag-category">{article.category}</span>
              <span className="meta-date">Published on {article.date}</span>
