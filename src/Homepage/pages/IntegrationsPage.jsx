...
const IntegrationsPage = () => {
  ...
  useEffect(() => {
    document.title = "System Integrations | ETR Aviation";
  }, []);
    ...
    <div className="public-page-container">
      ...
      <section className="page-hero">
        <div className="hero-content">
          <div className="trust-pill">
            <span className="dot">•</span> OPEN API & ECOSYSTEM CONNECTIVITY
          </div>
          <h1 className="hero-title">
            Seamlessly integrated with <span className="highlight-text-cyan">your aviation stack.</span>
          </h1>
        ...
        <div className="hero-widget">
          <div className="widget-card">
            <div className="widget-header">
              ...
              <div className="widget-tag">ETR API & INTEGRATION ARCHITECTURE</div>
            </div>
            ...
            <div className="ecosystem-diagram">
              ...
              <div className="node-sat n-top">Enterprise LMS</div>
              <div className="node-sat n-right">MRO / AMOS</div>
              <div className="node-sat n-bottom">Cloud S3 Vault</div>
      ...
      <section className="page-section">
        <div className="section-head">
          <span className="sub-tag">— INTEGRATION CONNECTORS</span>
          <h2 className="section-title">Pre-built integrations and customizable webhooks.</h2>
        </div>
      ...
      <section className="bottom-cta-section">
        <div className="cta-container">
          <h2 className="cta-title">Need a custom enterprise integration?</h2>
          <p className="cta-desc">Our technical solutions team assists with custom REST API connectors, data migrations, and webhook routing.</p>
