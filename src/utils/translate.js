...
export const VN_TO_EN = {
  ...
  'bỏ qua': 'skipped',
  // ── Bulk Import Users (Admin/User Management) ──
  ...
  'Vui lòng chọn file Excel trước khi kiểm tra.': 'Please choose an Excel file before validating.',
  'File hợp lệ, có thể nhập': 'File is valid and can be imported',
  'File có lỗi, cần sửa trước khi nhập': 'File has errors — fix them before importing',
  ...
  // ── ETR Detail status messages (Student portal) ──
  ...
  'Vô hiệu hóa thành công': 'Account disabled successfully',
  'Kích hoạt thành công': 'Account activated successfully',
  'Hủy': 'Cancel',
  ...
  '+ Tạo tài khoản học viên': '+ Create Learner Account',
  'Tất cả học viên': 'All Learners',
  ...
  'Giới tính': 'Gender',
  'Hồ sơ Học viên (User Profiles)': 'Learner Profiles (User Profiles)',
  'Quản lý hồ sơ học viên: Xem, tạo mới và cập nhật thông tin hồ sơ cho từng tài khoản học viên.': 'Manage learner profiles: View, create, and update profile information for each student account.',
  'Ngày sinh': 'Date of Birth',
  'Tổ chức': 'Organization',
  'Đang tải danh sách hồ sơ học viên...': 'Loading learner profiles...',
  'Không tìm thấy hồ sơ phù hợp.': 'No matching profiles found.',
  'Chưa có hồ sơ học viên nào trong hệ thống.': 'No learner profiles in the system.',
  ...
  'Các lớp bạn phụ trách và danh sách học viên có tỉ lệ điểm danh dưới ngưỡng cần nhắc nhở.': 'Classes assigned to you and learners with attendance rates below the minimum threshold.',
  ...
  'Bạn chưa được phân công lớp nào.': 'You are not assigned to any classes yet.',
  ...
  'Không có học viên nào dưới ngưỡng điểm danh.': 'No students below the attendance threshold.',
  'Danh sách buổi học': 'Session List',
  ' buổi đã tạo': ' sessions created',
  'Tìm buổi học...': 'Search session...',
  'Ngày học': 'Session Date',
  'Tên buổi học': 'Session Title',
  'Phòng học': 'Classroom',
  'Chỉ hiển thị lớp đã sắp xếp lịch dạy': 'Only show classes with scheduled sessions',
  'Tên khóa học / chuyên đề': 'Course / Subject Title',
  'Khóa ': 'Cohort ',
  'Sĩ số': 'Enrollment',
  ...
  'Lịch sử điểm danh của buổi học này cũng sẽ bị xóa theo.': 'Attendance history for this session will also be deleted.',
  ...
  'CẬP NHẬT': 'UPDATED',
  'THAO TÁC': 'ACTIONS',
  'Tìm ETR, học viên...': 'Search ETR, learner...',
  ...
  'Bạn có chắc chắn muốn xoá phòng ban': 'Are you sure you want to delete department',
  ...
  // ── Dashboard mới (Academic/Instructor) + bổ sung còn thiếu ──
...
export const EXTRA_VN_TO_EN = {
  ...
  // ── Training Manager: Yêu cầu mở khóa (Amendments) ──
  'YÊU CẦU MỞ KHÓA MÔN HỌC': 'SUBJECT UNLOCK REQUESTS',
  'Giảng viên xin mở khóa một SubjectResult đã ký xác nhận để sửa điểm/đánh giá. Duyệt sẽ đưa SubjectResult về Pending để giảng viên chỉnh sửa; từ chối giữ nguyên trạng thái.': 'Instructors request to unlock a signed SubjectResult to fix scores/assessments. Approving returns the SubjectResult to Pending for editing; rejecting keeps the current state.',
  ...
  'Giá trị cũ': 'Old Value',
  'Giá trị mới': 'New Value',
  'Chưa có yêu cầu mở khóa nào.': 'No unlock requests yet.',
  'Chờ duyệt': 'Pending',
  'Đã duyệt': 'Approved',
  'Đã từ chối': 'Rejected',
  'Duyệt': 'Approve',
  'Từ chối': 'Reject',
  'Bởi': 'By',
  'Không tải được danh sách yêu cầu mở khóa.': 'Failed to load unlock requests.',
  ...
  'SubjectResult sẽ được đưa về Pending để giảng viên chỉnh sửa; chữ ký cũ bị vô hiệu hóa. Có thể ghi chú quyết định (không bắt buộc).': 'The SubjectResult will return to Pending for the instructor to edit; the old signature is voided. A decision note is optional.',
  'Nhập ghi chú (tùy chọn)...': 'Enter note (optional)...',
  'XÁC NHẬN DUYỆT': 'CONFIRM APPROVE',
  'Từ chối yêu cầu mở khóa': 'Reject Unlock Request',
  'Yêu cầu sẽ bị từ chối và SubjectResult giữ nguyên trạng thái đã ký. Bắt buộc nêu lý do từ chối.': 'The request will be rejected and the SubjectResult keeps its signed state. A rejection reason is required.',
  'Nhập lý do từ chối...': 'Enter rejection reason...',

  // ── QA: Xác minh hàng loạt evidence ──
  'Xác thực tất cả minh chứng đang chờ (chưa khóa)': 'Verify all pending (unlocked) evidence',
  'Đã xác thực hàng loạt': 'Bulk verified',
  'minh chứng': 'evidence items',
  'minh chứng thất bại': 'evidence items failed',
  'Xác thực hàng loạt thất bại!': 'Bulk verification failed!',

  // ── Academic: Điểm danh thấp + Xuất báo cáo lớp ──
  'Điểm danh thấp': 'Low Attendance',
  ...
  'Chọn loại báo cáo — hệ thống sẽ sinh file và tải về máy.': 'Choose a report type — the system will generate and download the file.',
  'Báo cáo điểm danh': 'Attendance Report',
  'Báo cáo đánh giá': 'Assessment Report',
  'Tổng hợp lớp học': 'Class Summary',
  'Đang xuất...': 'Exporting...',
  'BE không trả về ExportJobId.': 'Backend did not return an ExportJobId.',
  'File xuất chưa hoàn thành. Vui lòng thử lại sau.': 'The export file is not ready yet. Please try again later.',
  'Xuất báo cáo thành công!': 'Report exported successfully!',
  'Xuất báo cáo thất bại.': 'Failed to export report.',

  // ── Instructor: Yêu cầu mở khóa điểm đã chốt ──
  'Vui lòng nhập lý do mở khóa.': 'Please enter an unlock reason.',
  ...
  'Xin mở khóa để sửa điểm — Training Manager sẽ duyệt qua Yêu cầu mở khóa': 'Request unlock to edit scores — Training Manager approves via Unlock Requests',
  'Mở khóa': 'Unlock',
  'Xin mở khóa để sửa điểm': 'Request Unlock to Edit Scores',
  'Điểm đã chốt không sửa trực tiếp được. Gửi yêu cầu mở khóa cho Training Manager — khi được duyệt, SubjectResult về Pending để bạn chỉnh sửa và ký lại.': 'Published scores cannot be edited directly. Send an unlock request to the Training Manager — once approved, the SubjectResult returns to Pending so you can edit and sign off again.',
  'Nhập lý do mở khóa...': 'Enter unlock reason...',
  'GỬI YÊU CẦU': 'SEND REQUEST',

  // ── Instructor: chặn điểm danh khi lớp đã kết thúc (ETR học viên đã khóa) ──
  'Lớp học đã kết thúc / bị hủy': 'Class is Completed / Cancelled',
  'Nếu hồ sơ ETR của học viên đã hoàn tất và bị khóa, hệ thống sẽ từ chối khi lưu / chốt / import điểm danh cho các buổi của lớp này. Hãy kiểm tra trạng thái lớp và ETR của học viên.': 'If the learners\' ETR records are Completed and locked, the system will reject saving / confirming / importing attendance for this class\'s sessions. Please check the class and ETR status.',
  'Lớp đã kết thúc — không thể nhập điểm danh': 'Class is completed — cannot import attendance',
  'Lớp đã kết thúc — không thể lưu điểm danh': 'Class is completed — cannot save attendance',
  'Lớp đã kết thúc — không thể chốt điểm danh': 'Class is completed — cannot confirm attendance',

  // ── Dashboard (chuỗi mới từ redesign các role) ──
  'Ghi danh': 'Enrollment',
  'Phân bố hồ sơ ETR theo trạng thái.': 'ETR records distribution by status.',
  'Phần trăm hồ sơ ETR đã hoàn thành.': 'Percentage of ETR records completed.',
  'Hồ sơ theo nhóm tuân thủ.': 'Records by compliance group.',
  'Không có mục cần đôn đốc.': 'No items to chase up.',
  'Nguồn:': 'Source:',
  'HỌC VIÊN THEO LỚP': 'STUDENTS PER CLASS',
  'Số học viên hiện tại của từng lớp bạn phụ trách.': 'Current number of students in each class you teach.',
  'Các lớp được phân công giảng dạy.': 'Classes assigned to you for teaching.',
  'Học viên có tỉ lệ điểm danh dưới ngưỡng tối thiểu.': 'Students with attendance rate below the minimum threshold.',
  'Phân bố hồ sơ theo trạng thái': 'Records distribution by status',
  'Dữ liệu từ GET /api/Etr/my-etr.': 'Data from GET /api/Etr/my-etr.',
};
...
export const EN_TO_VN = {
  ...
  // ── Auditor Dashboard Charts (ApexCharts) ──
  'Cancelled': 'Đã hủy',
  ...
  'Records by compliance group (completed, pending approval, returned, rejected, missing evidence).': 'Số hồ sơ theo nhóm tuân thủ (hoàn tất, chờ duyệt, trả về, từ chối, thiếu minh chứng).',
  ...
  'Locked vs Returned Trend': 'Xu hướng Khóa so với Trả về',
  'Records locked vs records returned by QA, per month over the last 8 months (smooth curves).': 'Số hồ sơ đã khóa so với số hồ sơ bị QA trả về, theo tháng trong 8 tháng gần nhất (đường cong trơn).',
  ...
  // ── Dashboard mới (bản tiếng Anh → tiếng Việt) ──
  ...
  // ── Dashboard redesign (chuỗi tiếng Anh mới từ các role) ──
