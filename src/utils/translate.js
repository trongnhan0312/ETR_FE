...
export const EN_TO_VN = {
  ...
  'This export will include the full validation timeline (Submitted / Verified / Completed) of the selected record.': 'Bản xuất này sẽ bao gồm toàn bộ mốc thời gian xác minh (Đã gửi / Đã thẩm định / Đã hoàn thành) của hồ sơ đã chọn.',
