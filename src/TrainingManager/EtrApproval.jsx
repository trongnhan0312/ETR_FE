...
const EtrApproval = () => {
  ...
  const [etrs, setEtrs] = useState([
    {
      id: "#ETR-2023-0042",
      traineeName: "Nguyen Van Long",
      traineeCode: "ID: AV-9923",
      initials: "NL",
      className: "A320 Type Rating - Initial",
      avgScore: 92.5,
      qaVerified: true,
      qaVerifier: "QA Officer Anna",
      submissionDate: "2026-06-23",
      status: "PENDING",
      instructor: "Capt. Henderson",
      assessments: [
        { name: "Ground School Exam", score: 95, date: "2026-05-15" },
        { name: "Simulator Session 1-5", score: 90, date: "2026-05-28" },
        { name: "Final Checkride", score: 93, date: "2026-06-20" },
      ],
    },
    {
      id: "#ETR-2023-0043",
      traineeName: "Tran Minh Hoang",
      traineeCode: "ID: AV-8812",
      initials: "TH",
      className: "Advanced Flight Safety Recurrent",
      avgScore: 89.0,
      qaVerified: true,
      qaVerifier: "QA Officer Anna",
      submissionDate: "2026-06-23",
      ...
      instructor: "Capt. Henderson",
      assessments: [
        { name: "Ground School Exam", score: 90, date: "2026-05-15" },
        { name: "Simulator Session 1-5", score: 88, date: "2026-05-28" },
        { name: "Final Checkride", score: 89, date: "2026-06-20" },
      ],
    },
    {
      id: "#ETR-2023-0044",
      traineeName: "Le Quoc Anh",
      traineeCode: "ID: AV-1042",
      initials: "LA",
      className: "Engine Flame-Out Simulation Training",
      avgScore: 94.2,
      qaVerified: true,
      qaVerifier: "QA Officer David",
      submissionDate: "2026-06-24",
      status: "PENDING",
      instructor: "Capt. Lopez",
      assessments: [
        { name: "Ground School Exam", score: 96, date: "2026-05-15" },
        { name: "Simulator Session 1-5", score: 92, date: "2026-05-28" },
        { name: "Final Checkride", score: 95, date: "2026-06-21" },
      ],
    },
    {
      id: "#ETR-2023-0038",
      traineeName: "Luu Duc Anh",
      traineeCode: "ID: AV-7742",
      initials: "DA",
      className: "Emergency Procedures Refresher",
      avgScore: 88.0,
      qaVerified: true,
      qaVerifier: "QA Officer Anna",
      ...
      instructor: "F.O. Miller",
      assessments: [
        { name: "Ditching Assessment", score: 85, date: "2026-06-15" },
        { name: "Evacuation Drill", score: 91, date: "2026-06-18" },
      ],
    },
    {
      id: "#ETR-2023-0035",
      traineeName: "Bui Thanh Son",
      traineeCode: "ID: AV-5521",
      initials: "TS",
      className: "Emergency Procedures Refresher",
      avgScore: 78.5,
      qaVerified: false,
      ...
      instructor: "F.O. Miller",
      returnReason:
        "Missing certified simulator log signatures for cockpit decompression procedures.",
      assessments: [
        { name: "Decompression Drill", score: 75, date: "2026-06-14" },
        { name: "Evacuation Drill", score: 82, date: "2026-06-18" },
      ],
    },
  ]);
