...
const TrainingManagerLayout = () => {
  ...
  const isHomePage = location.pathname === '/trainingmanager';
        ...
        <div>
          <div className="sidebar-brand">
            ...
            <div className="brand-text">
              ...
              <div className="brand-subtitle">{tr('Training Manager')}</div>
            </div>
          </div>
      ...
      <div className="academic-main">
        ...
        <header className="academic-topbar">
          <div className="search-wrapper">
            ...
            >
              {tr('AeroMetric Aviation Systems / Training Manager Space')}
            </div>
          ...
          <div className="topbar-right">
            <button className="notification-btn" type="button" aria-label={tr('Notifications')} onClick={() => setShowNotifications(!showNotifications)}>
              <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
